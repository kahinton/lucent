...
DEV_USER_NAME = os.environ.get("MNEMEMCP_DEV_USER_NAME", "Development User")
DEV_ORG_NAME = os.environ.get("MNEMEMCP_DEV_ORG_NAME", "Development Organization")
...
def is_dev_mode() -> bool:
    ...
    Returns:
        True if MNEMEMCP_DEV_MODE is enabled.
    """
    return DEV_MODE
