---
name: docker-operations-fix
description: 'Replace placeholder code-review content in docker-operations, docker-operations-specialized, security-audit, test-coverage-analysis, test-coverage-analysis-specialized, and api-testing skills with actual domain-specific procedures'
---

# Docker Operations Fix
