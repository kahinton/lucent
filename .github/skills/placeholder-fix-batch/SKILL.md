---
name: placeholder-fix-batch
description: 'Replace the 10 placeholder skills that still contain code-review template text with actual domain-specific content'
---

# Placeholder Fix Batch
