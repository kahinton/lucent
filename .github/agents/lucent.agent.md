...
tools: [vscode/extensions, vscode/askQuestions, vscode/getProjectSetupInfo, vscode/installExtension, vscode/memory, vscode/newWorkspace, vscode/runCommand, vscode/vscodeAPI, execute/getTerminalOutput, execute/killTerminal, execute/sendToTerminal, execute/createAndRunTask, execute/runTests, execute/runNotebookCell, execute/testFailure, execute/runInTerminal, read/terminalSelection, read/terminalLastCommand, read/getNotebookSummary, read/problems, read/readFile, agent/runSubagent, browser/openBrowserPage, browser/readPage, browser/screenshotPage, browser/navigatePage, browser/clickElement, browser/dragElement, browser/hoverElement, browser/typeInPage, browser/runPlaywrightCode, browser/handleDialog, memory-server/approve_agent_definition, memory-server/approve_mcp_server_definition, memory-server/approve_skill_definition, memory-server/claim_task, memory-server/create_agent_definition, memory-server/create_daemon_task, memory-server/create_mcp_server_definition, memory-server/create_memory, memory-server/create_request, memory-server/create_review, memory-server/create_schedule, memory-server/create_skill_definition, memory-server/create_task, memory-server/delete_agent_definition, memory-server/delete_memory, memory-server/delete_skill_definition, memory-server/export_memories, memory-server/get_agent_definition, memory-server/get_current_user_context, memory-server/get_existing_tags, memory-server/get_memories, memory-server/get_memory, memory-server/get_memory_versions, memory-server/get_request_details, memory-server/get_schedule_details, memory-server/get_skill_definition, memory-server/get_tag_suggestions, memory-server/grant_mcp_server_to_agent, memory-server/grant_skill_to_agent, memory-server/import_memories, memory-server/link_request_memory, memory-server/link_task_memory, memory-server/list_active_work, memory-server/list_agent_definitions, memory-server/list_available_models, memory-server/list_mcp_server_definitions, memory-server/list_pending_requests, memory-server/list_pending_tasks, memory-server/list_proposals, memory-server/list_reviews, memory-server/list_schedules, memory-server/list_skill_definitions, memory-server/log_task_event, memory-server/reject_agent_definition, memory-server/reject_mcp_server_definition, memory-server/reject_skill_definition, memory-server/release_claim, memory-server/restore_memory_version, memory-server/revoke_mcp_server_from_agent, memory-server/revoke_skill_from_agent, memory-server/search_memories, memory-server/search_memories_full, memory-server/toggle_schedule, memory-server/update_agent_definition, memory-server/update_mcp_server_definition, memory-server/update_memory, edit/createDirectory, edit/createFile, edit/createJupyterNotebook, edit/editFiles, edit/editNotebook, edit/rename, search/changes, search/codebase, search/fileSearch, search/listDirectory, search/textSearch, search/usages, web/fetch, pylance-mcp-server/pylanceDocString, pylance-mcp-server/pylanceDocuments, pylance-mcp-server/pylanceFileSyntaxErrors, pylance-mcp-server/pylanceImports, pylance-mcp-server/pylanceInstalledTopLevelModules, pylance-mcp-server/pylanceInvokeRefactoring, pylance-mcp-server/pylancePythonEnvironments, pylance-mcp-server/pylanceRunCodeSnippet, pylance-mcp-server/pylanceSettings, pylance-mcp-server/pylanceSyntaxErrors, pylance-mcp-server/pylanceUpdatePythonEnvironment, pylance-mcp-server/pylanceWorkspaceRoots, pylance-mcp-server/pylanceWorkspaceUserFiles, todo]
---
